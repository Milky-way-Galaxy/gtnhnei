import { Fluid, Item, RecipeIoType, Repository } from "./repository.js";
...
export class StandardOverclocker extends Overclocker {
    constructor(maxPerfect, maxNormal, multiplier) {
        super();
        this.maxPerfect = maxPerfect;
        this.maxNormal = maxNormal;
        this.multiplier = multiplier;
    }
    static onlyPerfect(maxPerfect = MAX_OVERCLOCK, multiplier = 4) {
    ...
    calculate(recipeModel, overclockTiers) {
...
NullOverclocker.instance = new NullOverclocker();
...
export function GetParameter(coefficient, recipeModel) {
    if (typeof coefficient === "function")
        return coefficient(recipeModel, recipeModel.choices);
    else
        return coefficient;
}
function createEditableCopy(items) {
...
export const singleBlockMachine = {
    overclocker: StandardOverclocker.onlyNormal(),
    speed: 1,
    power: 1,
    parallels: 1,
    excludesRecipe: (recipe) => {
        var _a;
        return ((_a = recipe.gtRecipe.MetadataByKey("compression_tier")) !== null && _a !== void 0 ? _a : 0) > 0;
    }
};
const singleBlockMachineWith22Overclock = {
    overclocker: StandardOverclocker.onlyNormal(),
    speed: 1,
...
machines["Component Assembly Line"] = {
    ...
    speed: (recipeModel, choices) => {
        var _a, _b;
        const recipeCoalTier = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("coal_casing_tier")) !== null && _b !== void 0 ? _b : 1;
...
machines["Naquadah Fuel Refinery"] = {
    ...
    overclocker: (recipeModel, choices) => {
        ...
        const recipeTierCoil = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("nfr_coil_tier")) !== null && _b !== void 0 ? _b : 1;
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b;
        const recipeTier = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("nfr_coil_tier")) !== null && _b !== void 0 ? _b : 1;
...
machines["Neutron Activator"] = {
    ...
    info: (recipeModel, choices) => {
        var _a, _b;
        const nke = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("nke_range")) !== null && _b !== void 0 ? _b : 0;
...
function makeSpaceAssemblerRecipeExcluder(tier) {
    return (recipe) => recipe.gtRecipe.MetadataByKey("space_elevator_module_tier") > tier;
}
...
function getEbfExcessHeat(recipe, choices) {
    var _a, _b;
    const recipeHeat = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.specialValue) !== null && _b !== void 0 ? _b : 0;
...
function makeEbfOverclocker(recipe, choices) {
...
function ebfPower(recipe, choices) {
    const excessHeat = getEbfExcessHeat(recipe, choices);
...
function laserOverclockCalculator(recipeModel, overclockTiers) {
    var _a, _b, _c, _d, _e;
    const amperage = recipeModel.choices.inputAmperage;
    const availableEut = voltageTier[recipeModel.voltageTier].voltage * amperage;
    let currentEut = (((_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.voltage) || 32) * recipeModel.getItemInputCount();
    // We will need to limit to 1 per tick at most for AAL.
    const parallel = recipeModel.getItemInputCount();
    const durationTicks = (((_c = recipeModel.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe.durationTicks) || Number.POSITIVE_INFINITY);
    let overclockSpeed = 1;
    let overclockPower = 1;
    const maxRegularOverclocks = recipeModel.voltageTier - (((_e = (_d = recipeModel.recipe) === null || _d === void 0 ? void 0 : _d.gtRecipe) === null || _e === void 0 ? void 0 : _e.voltageTier) || TIER_LV);
    ...
    while (true) {
        ...
        if (potentialEU >= availableEut)
            break;
        if (estimatedDurationTicks < parallel)
            break;
        currentEut = potentialEU;
        overclockSpeed *= 2;
        overclockPower *= multiplier / 2;
        laserOverclocks += 1;
        if (laserOverclocks + regularOverclocks > maxRegularOverclocks + (Math.log(amperage) / Math.log(4)))
            break;
    }
...
let precisionLatheParallels = [1, 1, 2, 4, 8, 12, 16, 32];
let precisionLatheSpeed = [0.75, 0.8, 0.9, 1, 1.5, 2, 3, 4];
...
machines["Nano Forge"] = {
    overclocker: (recipeModel, choices) => {
        ...
        const neededTier = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("nano_forge_tier")) !== null && _b !== void 0 ? _b : 1;
    ...
    recipe: (recipe, choices, items) => {
        ...
        let magmatterFluid = {
            ...
            goodsPtr: 0,
            goods: Repository.current.GetById("f:gregtech:molten.magmatter"),
            slot: 0,
    ...
    enforceChoiceConstraints: (recipeModel, choices) => {
        var _a, _b;
        const tier = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("nano_forge_tier")) !== null && _b !== void 0 ? _b : 1;
...
function makeCompressorRecipeExcluder(tier) {
    return (recipe) => { var _a; return tier < ((_a = recipe.gtRecipe.MetadataByKey("compression_tier")) !== null && _a !== void 0 ? _a : 0); };
}
...
class DtpfCatalyst {
    constructor(tier, displayName, id, euPerLiter, residuePerLiter) {
        this.tier = tier;
...
let DtpfCatalysts = [
    new DtpfCatalyst(0, "Crude", "f:gregtech:exciteddtcc", 14514093, 0.125),
    new DtpfCatalyst(1, "Prosaic", "f:gregtech:exciteddtpc", 66768460, 0.25),
    new DtpfCatalyst(2, "Resplendent", "f:gregtech:exciteddtrc", 269326451, 0.5),
    new DtpfCatalyst(3, "Exotic", "f:gregtech:exciteddtec", 1073007393, 1.0),
    new DtpfCatalyst(4, "Stellar", "f:gregtech:exciteddtsc", 4276767521, 2.0),
];
let DtpfCatalystById = Object.fromEntries(DtpfCatalysts.map(cat => [cat.id, cat]));
function findDtpfCatalyst(items) {
    for (let i = 0; i < items.length; i++) {
        let item = items[i];
        if (item.type == RecipeIoType.FluidInput) {
            let id = item.goods.id;
...
machines["Dimensionally Transcendent Plasma Forge"] = {
    ...
    recipe: (recipe, choices, items) => {
        ...
        if (choices.convergence > 0) {
            ...
            let amperage = ((_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.amperage) || 1;
            let voltage = ((_b = recipe.recipe) === null || _b === void 0 ? void 0 : _b.gtRecipe.voltage) || TIER_LV;
            let machineConsumption = amperage * voltage * Math.pow(4, recipe.overclockTiers);
            let durationTicks = (((_c = recipe.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe.durationTicks) || 1) / Math.pow(4, recipe.overclockTiers);
            ...
            let transdimensionalAlignmentMatrixItem = {
                type: RecipeIoType.ItemInput,
                goodsPtr: 0,
                goods: Repository.current.GetById("i:gregtech:gt.metaitem.03:32758"),
                slot: 0,
                amount: 0,
                probability: 1.0
            };
            let catalystFluid = {
                type: RecipeIoType.FluidInput,
                goodsPtr: 0,
                goods: Repository.current.GetById(catalyst.id),
                slot: 0,
            ...
            let residueFluid = {
                ...
                goodsPtr: 0,
                goods: Repository.current.GetById("f:gregtech:dimensionallytranscendentresidue"),
                slot: 0,
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        ...
        let catalyst = findDtpfCatalyst(((_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.items) || []);
        if (catalyst) {
...
machines["Matter Fabrication CPU"] = {
    ...
    parallels: (recipe, choices) => {
        var _a, _b;
        let scrap = ((_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.voltageTier) == TIER_LV;
...
machines["Quantum Force Transformer"] = {
    ...
    recipe: (recipe, choices, items) => {
        ...
        if (numOutputs == 0) {
            return (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.items) !== null && _b !== void 0 ? _b : [];
        }
        const focusTier = (_d = (_c = recipe.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe.MetadataByKey("qft_focus_tier")) !== null && _d !== void 0 ? _d : 1;
        const baseProbability = 1.0 / numOutputs;
        items = createEditableCopy(((_e = recipe.recipe) === null || _e === void 0 ? void 0 : _e.items) || []);
        ...
        if (choices.focusedOutput > 0) {
            let neptuniumPlasmaFluid = {
                type: RecipeIoType.FluidInput,
                goodsPtr: 0,
                goods: Repository.current.GetById("f:miscutils:plasma.neptunium"),
                slot: 0,
        ...
        if (choices.focusedAll) {
            let fermiumPlasmaFluid = {
                type: RecipeIoType.FluidInput,
                goodsPtr: 0,
                goods: Repository.current.GetById("f:miscutils:plasma.fermium"),
                slot: 0,
                amount: Math.floor(4 * (choices.shielding + 1) * Math.sqrt(choices.catalysts)),
                probability: 1.0
            };
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b;
        const focusTier = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("qft_focus_tier")) !== null && _b !== void 0 ? _b : 1;
...
machines["Draconic Evolution Fusion Crafter"] = {
    overclocker: (recipe, choices) => {
        ...
        const recipeTierCoil = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("defc_casing_tier")) !== null && _b !== void 0 ? _b : 1;
        const maxPerfectOverclocks = Math.max(0, buildingTierCoil - recipeTierCoil);
        return StandardOverclocker.perfectThenNormal(maxPerfectOverclocks);
    },
    speed: 1,
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b;
        const recipeTier = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.MetadataByKey("defc_casing_tier")) !== null && _b !== void 0 ? _b : 1;
...
function getFusionTier(recipe) {
    var _a, _b;
    const cost = (_a = recipe.gtRecipe.MetadataByKey("fusion_threshold")) !== null && _a !== void 0 ? _a : 0;
    const plasmaTier = (_b = recipe.gtRecipe.MetadataByKey("fog_plasma_tier")) !== null && _b !== void 0 ? _b : 0;
...
function makeFusionOverclocker(fusionTier, overclockMultiplier) {
    return function (recipeModel, choices) {
...
function makeFusionRecipeExcluder(tier) {
    return (recipe) => {
...
function getCompactFusionParallel(recipe, tier) {
...
function getEyeOfHarmonyRecipeTier(recipeModel) {
    var _a;
    let planetItem = undefined;
    const items = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.items;
    if (items === undefined)
        return 0;
    for (let i = 0; i < items.length; ++i) {
        const item = items[i];
    ...
    const parts = planetItem.goods.name.split(":");
    if (parts.length == 2) {
        // Remove leading "T".
...
function getEyeOfHarmonySuccessRateWithPity(originalSuccessRate) {
...
function getEyeOfHarmonySpeed(recipeModel, choices) {
...
function getEyeOfHarmonyParallel(astralArrays) {
    if (astralArrays == 0)
        return 1;
...
machines["Eye of Harmony"] = {
    ...
    recipe: (recipeModel, choices, items) => {
        ...
        let spacetimeFluid = {
            type: RecipeIoType.FluidOutput,
            goodsPtr: 0,
            goods: Repository.current.GetById("f:gregtech:molten.spacetime"),
            slot: 0,
            amount: rawSuccessChance * 14400 * Math.pow(2, recipeTier),
            probability: 1 - successChance
        };
        items.push(spacetimeFluid);
        const recipeDurationSeconds = (((_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe.durationSeconds) || 1) / getEyeOfHarmonySpeed(recipeModel, choices);
