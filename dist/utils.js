...
export function getFusionTierByStartupCost(euToStart) {
    if (euToStart < 10000000 * 16)
        return 1;
    else if (euToStart < 20000000 * 16)
        return 2;
    else if (euToStart < 40000000 * 16)
        return 3;
    else if (euToStart < 320000000 * 16)
        return 4;
    else if (euToStart < 1280000000 * 16)
        return 5;
    else
        throw RangeError("Fusion startup cost is too high.");
}
export var voltageTier = [
    { name: "LV", voltage: 32 },
    { name: "MV", voltage: 128 },
    { name: "HV", voltage: 512 },
